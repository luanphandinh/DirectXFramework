...
void IControlable::updateInput(float deltaTime)
{
...
void BaseObject::setPhysicBodySide(eDirection direction)
{
	if (direction != _physicsSide)
		_physicsSide = direction;
}

eDirection BaseObject::getPhysicBodySide()
{
	return _physicsSide;
}
